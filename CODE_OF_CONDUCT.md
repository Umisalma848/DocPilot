...
Given DocPilot's focus on healthcare technology, we also emphasize:

- **Patient Privacy**: Never share or discuss real patient information in any community spaces
- **Medical Accuracy**: Be responsible when discussing medical concepts; always defer to qualified healthcare professionals
- **Accessibility**: Consider the needs of users with disabilities in all contributions
- **Data Security**: Take security seriously in all discussions and contributions
- **Professional Standards**: Maintain the high standards expected in healthcare technology
